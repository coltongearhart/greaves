...
knitr::opts_chunk$set(
  ...
  cache = TRUE, # cache output and objects to speed up building process (broken by modifying code chunks / options)
...
<!-- NOTE: add display nice function from regression to the source files and display calcs, but not in destination -->
...
data_sample2 %>% display_nice(col.names = c("Iteration", "$X$", "$\\lambda$"))
